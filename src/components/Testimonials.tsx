        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            <div className="apple-card-lg p-12 text-center">
              ...
              <blockquote className="text-3xl font-light text-black leading-relaxed mb-12 font-display">
              ...
              <div className="flex items-center justify-center space-x-4">
                ...
                <div className="text-left">
                  <div className="text-black font-semibold">{testimonials[currentIndex].author}</div>
